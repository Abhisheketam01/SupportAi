    ...
    return (
        <div
            ...
            <div className='sticky top-0 z-40 bg-white border-b border-zinc-200'>
                <div className='max-q-7xl mx-auto px-6 h-16 flex items-center justify-between'>
            ...
            <div className='flex justify-center px-4 py-13'>
                <motion.div
                ...
                >
                    ...
                    <div className='relative bg-zinc-900 text-zinc-100 rounded-xl p-5 text-sm font-mono mb-10'>
                        ...
                        <button className='absolute top-3 right-3 bg-white text-zinc-900 text-xs font-medium px-3 py-1.5 rounded-lg hover:bg-zinc-200 trabsition' onClick={copyCode}  >
                            {copied ? "Copied ✓ " : "Copy"}
                        </button>
                    </div>

                    <ol className='space-y-1 text-sm text-zinc-600 list-decimal list-inside font-mono'>

                        <li>Copy the emebd script</li>
                        <li>Paste it beforfe the closing body tag</li>
                    ...
                    <div className='mt-14'>
                        ...
                        <p className='text-sm text-zinc-500 mb-6 font-mono bold'>This is how the chatbot will appear on your webiste. </p>
